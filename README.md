...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/dogxii/iNav)

（预计 1.0 版本增加 Docker 一键部署支持）
...
（该方式仅本地添加，不修改后台数据，后台管理预计 1.0 版本发布！）
